...
final class FeedLoaderWithFallbackCompositeTests: XCTestCase {
    ...
    private func expect(_ sut: FeedLoaderWithFallbackComposite, toCompleteWith expectedResult: FeedLoaderWithFallbackComposite.Result, file: StaticString = #filePath, line: UInt = #line) {
