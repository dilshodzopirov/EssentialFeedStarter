...
//
//  Created by Dilshod Zopirov on 8/29/25.
//
...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchedFixedTestAccountData() {
        ...
        case .success(let imageFeed):
            XCTAssertEqual(imageFeed.count, 8, "Expected 8 items in the account feed")
    ...
    func test_endToEndTestServerGETFeedImageDataResult_matchesFixedAccountData() {
        ...
        case let .failure(error)?:
            XCTFail("Expected successfull image data result, got \(error) instead")
        default:
